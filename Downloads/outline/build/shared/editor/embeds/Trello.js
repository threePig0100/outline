...
function Trello(_ref) {
  ...
  if (matches[1] === "c") {
    return /*#__PURE__*/React.createElement(_Frame.default, {
      width: "316px",
      height: "141px",
      src: "https://trello.com/embed/card?id=".concat(objectId),
      title: "Trello Card (".concat(objectId, ")")
    });
  }
  return /*#__PURE__*/React.createElement(_Frame.default, _extends({}, props, {
    width: "248px",
    height: "185px",
    src: "https://trello.com/embed/board?id=".concat(objectId),
    title: "Trello Board (".concat(objectId, ")")
  }));
}
