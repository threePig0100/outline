...
class ConfirmUserDeleteEmail extends _BaseEmail.default {
  ...
  renderAsText(_ref) {
    ...
    return "\nYou requested to permanently delete your ".concat(_env.default.APP_NAME, " account. Please enter the code below to confirm your account deletion.\n\nCode: ").concat(deleteConfirmationCode, "\n");
  }
  render(_ref2) {
    let {
      deleteConfirmationCode
    ...
    }, /*#__PURE__*/React.createElement(_Header.default, null), /*#__PURE__*/React.createElement(_Body.default, null, /*#__PURE__*/React.createElement(_Heading.default, null, "Your account deletion request"), /*#__PURE__*/React.createElement("p", null, "You requested to permanently delete your ", _env.default.APP_NAME, " account. Please enter the code below to confirm your account deletion."), /*#__PURE__*/React.createElement(_EmptySpace.default, {
      height: 5
