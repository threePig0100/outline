...
class CommentCreatedEmail extends _BaseEmail.default {
  async beforeSend(props) {
    ...
    const firstComment = await _models.Comment.findOne({
      attributes: ["id"],
      where: {
        documentId
      },
    ...
    const isFirstComment = (firstComment === null || firstComment === void 0 ? void 0 : firstComment.id) === commentId;
    return {
      document,
      collection,
      isReply,
  ...
  subject(_ref2) {
    ...
    return "".concat(isFirstComment ? "" : "Re: ", "New comment on \u201C").concat(document.title, "\u201D");
  }
  preview(_ref3) {
    let {
      isReply,
    ...
    return isReply ? "".concat(actorName, " replied in a thread") : "".concat(actorName, " commented on the document");
  }
  fromName(_ref4) {
    let {
      actorName
  ...
  renderAsText(_ref5) {
    ...
    return "\n".concat(actorName, " ").concat(isReply ? "replied to a thread in" : "commented on", " \"").concat(document.title, "\"").concat(collection.name ? "in the ".concat(collection.name, " collection") : "", ".\n\nOpen Thread: ").concat(teamUrl).concat(document.url, "?commentId=").concat(commentId, "\n");
  }
  render(props) {
    const {
      document,
    ...
    }, /*#__PURE__*/React.createElement(_Header.default, null), /*#__PURE__*/React.createElement(_Body.default, null, /*#__PURE__*/React.createElement(_Heading.default, null, document.title), /*#__PURE__*/React.createElement("p", null, actorName, " ", isReply ? "replied to a thread in" : "commented on", " ", /*#__PURE__*/React.createElement("a", {
      href: threadLink
