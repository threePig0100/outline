...
const url = (_env$CDN_URL = _env.default.CDN_URL) !== null && _env$CDN_URL !== void 0 ? _env$CDN_URL : _env.default.URL;
var _default = () => /*#__PURE__*/React.createElement(_oyVey.Table, {
  ...
  src: _env.default.isCloudHosted ? "".concat(url, "/email/header-logo.png") : "cid:header-image",
  height: "48",
  width: "48"
})))));
