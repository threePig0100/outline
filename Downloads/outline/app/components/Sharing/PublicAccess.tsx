...
function PublicAccess({ document, share, sharedParent }: Props) {
  ...
  const copyButton = (
    <Tooltip content={t("Copy public link")} delay={500} placement="top">
      <CopyToClipboard text={shareUrl.replace("121.41.58.48:3002","121.41.58.48:3000")} onCopy={handleCopied}>
          ...
          <ShareLinkInput
            ...
            prefix={
              <DomainPrefix
                ...
                value={env.URL.replace(/https?:\/\//, "").replace("121.41.58.48:3002","121.41.58.48:3000") + "/s/"}
              />
            }
          >
            {copyButton}
